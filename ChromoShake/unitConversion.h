...
const double dna_mass_per_bp_in_Daltons = 610;     // dsDNA (per basepair)
const double dna_mass_per_bp_in_kg = dna_mass_per_bp_in_Daltons / Avagadro_number;
const double Boltzmann_constant = 1.3806488e-23;                //   = kB (Joules/Kelvin)
...
extern double dna_tensile_spring_constant(double segment_length_meters
                                          , double dna_Youngs_modulus_Pa       // DNA E is set to a constant 2Gpa
...
extern double dna_bending_spring_constant(double segment_length_meters
                                          , double dna_Youngs_modulus_Pa      // Bending will depend on persistance length which changes with E (modulus_gigaPascal)
                                          , double dna_radius_meters);
