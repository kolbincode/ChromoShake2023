...
int main(int argc,const char *argv[])
{
...

    {
        ...
        variableDataFile = DTDataFile("table.dtbin",DTFile::ReadOnly);
        Read(variableDataFile,"table",table);
        variableDataFile = DTDataFile("chromosomes.dtbin",DTFile::ReadOnly);
        Read(variableDataFile,"chromosomes",chromosomes);
    }
    ...
    //DTTimer timer;
    //timer.Start();
    DTTable output = Computation(table,chromosomes);
