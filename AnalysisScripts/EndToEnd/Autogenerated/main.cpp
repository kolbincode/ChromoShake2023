...
int main(int argc,const char *argv[])
{
...

    {
        ...
        variableDataFile = DTDataFile("BeadPos.dtbin",DTFile::ReadOnly);
        Read(variableDataFile,"BeadPos",BeadPos);
    ...
    //DTTimer timer;
    //timer.Start();
    DTTable output = Computation(BeadPos,Stride);
