...
int main(int argc,const char *argv[])
{
    ...
    DTTable RG_combined_table;

    {
        // Inside a scope so that the input data file will be closed before the computation is called.
        DTDataFile variableDataFile;

        variableDataFile = DTDataFile("RG combined table.dtbin",DTFile::ReadOnly);
        Read(variableDataFile,"RG combined table",RG_combined_table);
    }
    ...
    //DTTimer timer;
    //timer.Start();
    DTTable output = Computation(RG_combined_table);
