...
int main(int argc,const char *argv[])
{
...

    {
        ...
        variableDataFile = DTDataFile("BeadPositions.dtbin",DTFile::ReadOnly);
        Read(variableDataFile,"BeadPositions",BeadPositions);
    ...
    //DTTimer timer;
    //timer.Start();
    DTTable output = Computation(BeadPositions,Stride);
