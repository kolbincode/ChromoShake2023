...
int main(int argc,const char *argv[])
{
...

    {
        ...
        variableDataFile = DTDataFile("PositionBeads.dtbin",DTFile::ReadOnly);
        Read(variableDataFile,"PositionBeads",PositionBeads);
    ...
    //DTTimer timer;
    //timer.Start();
    DTTable output = Computation(PositionBeads,Stride);
